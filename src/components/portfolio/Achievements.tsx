        ...
        >
          ...
          <ul className="space-y-3">
            {achievements.map((a) => (
              <li
                key={a}
                className="flex items-start gap-3 rounded-xl border border-white/5 bg-white/[0.03] p-3 transition hover:border-primary/30"
              >
        ...
        >
          ...
          <ul className="grid gap-3 sm:grid-cols-2">
            {certs.map((c) => (
              <li
                key={c.name}
                className="group flex items-start gap-3 rounded-xl border border-white/5 bg-white/[0.03] p-3 transition hover:border-primary/30 hover:bg-white/[0.06]"
              >
