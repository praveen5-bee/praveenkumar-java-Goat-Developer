...
const groups = [
  { icon: Code2, title: "Backend", items: ["Java", "Spring Boot", "Spring MVC", "REST APIs", "Hibernate", "JPA", "JPQL"] },
  ...
  { icon: Network, title: "Architecture", items: ["Microservices", "API Integrations", "Caching", "Database Optimization"] },
];
