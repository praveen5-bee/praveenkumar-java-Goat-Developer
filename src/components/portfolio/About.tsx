...
export function About() {
  return (
    <Section id="about" eyebrow="About Me" title="Passionate about building backends that scale">
      <div className="grid items-start gap-10 lg:grid-cols-5">
        ...
        >
          <p className="text-base leading-relaxed text-muted-foreground sm:text-lg">
            Passionate <span className="font-semibold text-foreground">Java Backend Developer</span>{" "}
            with hands-on experience building scalable Spring Boot applications, secure REST APIs,
            fintech solutions, and third-party integrations. Specialized in{" "}
            <span className="font-semibold text-primary">
              Insurance, Loan, and Bus Booking Platforms
            </span>{" "}
            with expertise in Java, Spring Boot, Redis, PostgreSQL, JWT Authentication, and
